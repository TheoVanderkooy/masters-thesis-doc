...
\documentclass[letterpaper,12pt,titlepage,oneside,final,pdftex,pdfa,pagebackref=false]{book}
...
% \usepackage[pdftex,pdfa,pagebackref=false]{hyperref} % with basic options
...
\hypersetup{
    ...
    pdfkeywords= {buffer management} {caching} {database}, % list of keywords, and uncomment this line if desired
...
\input{chapters/1-background-related-work}

\input{chapters/2-pbm-sampling}

\input{chapters/3-improving-sampling}

\input{chapters/4-postgres-implementation}
...
\input{appendices/0-sampling-analysis}

% \input{appendices/1-hdd-experiments}
